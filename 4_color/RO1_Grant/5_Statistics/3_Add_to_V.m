...
clear all;clc
%%
base_path = 'Y:\Chenghang\07_4_Color\chenghaz_001_Sample_01_A\';
...
% outpath_syn = 'Y:\Chenghang\07_4_Color\chenghaz_001_Sample_01_A\analysis\elastic_align\Result\';
%%
load([outpath 'V_paired.mat']);
statsSwater = statsVwater_ss;
clear statsGwater
%
...
%%
save([outpath 'add_to_Vs.mat'],'centG_p280','tintsG_p280',...)
    'volumeG_p280','statxture_all','statxture_pos','-v7.3')
save([outpath 'statsVs_plus.mat'],'statsVwater','-v7.3')