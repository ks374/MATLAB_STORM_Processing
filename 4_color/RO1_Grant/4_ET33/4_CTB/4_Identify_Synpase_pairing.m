base_folder = 'Z:\Chenghang\chenghaz_007_Sample_Epi_Contra_A\';
outpath = base_folder;
outpath2 = 'Z:\Chenghang\chenghaz_005_Sample_P8_C_A\analysis\elastic_align\Result\';
%%
load([outpath2 'R_paired.mat']);
voxel = [15.5 15.5 70];
%
...
%%
save([base_folder 'nearest_neightbor_pairing_vw10sw10.mat'],'nn_*')
%%
binsl = 0:0.05:5;
...
savefig([base_folder 'nnvsplit_Ss_counts_with_and_all.fig'])
%%
%figure;
...
savefig([base_folder 'nnSsplit_Vs_counts_with_and_all.fig'])
%
%figure;
