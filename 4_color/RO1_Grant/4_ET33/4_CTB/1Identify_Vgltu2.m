...
clc
%%
base_path = 'Y:\Chenghang\05_4_color_test\chenghaz_005_Sample_P8_C_A\';
...
mask_folder = [path 'Result/1_Soma_Mask/'];
maskfiles = [dir([mask_folder '*.tif']) dir([mask_folder '*.png'])];

%set voxel size in nm
voxel=[15.5, 15.5, 70];
outpath = 'Y:\Chenghang\05_4_color_test\chenghaz_005_Sample_P8_C_A\analysis\elastic_align\Result\CTB\';
...
% parfor i = 1:num_images
    imwrite(Result(:,:,i),[outpath 'Maked2_' sprintf('%03d',i) '.tif']);
% end
...
save([outpath 'sizeshapematC_and_cent_water10_area_cutoff.mat'],'centGw','sizeshape_mat')
save([outpath 'statsCwater10_area_cutoff.mat'],'statsGwater','-v7.3')
%%
clear