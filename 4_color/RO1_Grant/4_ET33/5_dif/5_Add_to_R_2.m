...
%%
load([outpath_V 'V_CTB_paired.mat']);
statsRwater = statsVwater_n;
%%
...
%%
right_idx = find(tintsG_p140);
statsRwater_ncs = statsGwater(right_idx);
save([outpath 'R_nCV_paired.mat'],'statsRwater_ncs')
%%
