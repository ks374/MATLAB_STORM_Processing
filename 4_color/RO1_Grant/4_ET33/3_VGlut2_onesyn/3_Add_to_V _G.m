...
outpath_syn = 'Z:\Chenghang\chenghaz_008_Sample_Epi_Ipsi_A\analysis\elastic_align\Result\';
%%
load([outpath_syn 'statsGwater10_area_cutoff.mat']);
statsRwater = statsGwater;
clear statsGwater
%
...
statsVwater(i).tints_p210 = [];
statsVwater(i).volume_p210 = [];
statsVwater(i).area_p210 = [];
statsVwater(i).WeightedCentroid_p210 = [];
statsVwater(i).statxtureP_210all = [];
statsVwater(i).statxtureP_210pos = [];
centG_p210(i,1:3) = 0;
tintsG_p210(i) = 0;
volumeG_p210(i) =0;
