...
clc
%%
base_path = 'Z:\Chenghang\chenghaz_014_XB2_P2_Control_B\';
...
outpath = 'Z:\Chenghang\chenghaz_014_XB2_P2_Control_B\analysis\Result\Rand\';
outpath2 = 'Z:\Chenghang\chenghaz_014_XB2_P2_Control_B\analysis\Result\';
%%
load([outpath 'statsG_n_rand.mat']);
statsRwater = statsGwater_n_random;
clear statsGwater_n_random
%
load([outpath 'statsR_n_rand.mat']);
