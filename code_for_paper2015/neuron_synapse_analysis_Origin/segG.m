...
%
%figure;
%imshow(imadjust(squeeze(max(bg2,[],2))));%(:,5000,:)))
%
clear hy1
parfor j=1:num_images
    disp(j)
...
%
save([path 'sizeshapematG_and_cent_water10_area_cutoff.mat'],'centGw','sizeshape_mat')
save([path 'statsGwater10_area_cutoff.mat'],'statsGwater','-v7.3')
%%
clear all