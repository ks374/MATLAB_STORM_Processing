...
%base_path = '/Volumes/contefs1/backup/ysigal/';

%exp_folder = [base_path 'GLD3_bistratified_RGC/'];
%exp_folder = [base_path '03_22_13_sample1A_GABA_gephyrin/'];
%exp_folder = [base_path '03_22_13_sample2A_GlyR_gephyrin/'];
exp_folder = [base_path 'REIT_3rd_proc/'];
%exp_folder = [base_path 'GLD3_bistratified_RGC/'];
%exp_folder = [base_path 'YRT2/'];
%exp_folder = [base_path 'aligned_data_stacks/sample1C_013013_glyR_AC/'];
%exp_folder = [base_path 'aligned_data_stacks/03_22_13_sample2A_GlyR_gephyrin/'];
%exp_folder = [base_path 'aligned_data_stacks/09_01_13_sample1A_GABA_alpha2_gephyrin/'];
%exp_folder = [base_path 'aligned_data_stacks/09_01_13_sample2A_presynaptic_gephyrin/'];
