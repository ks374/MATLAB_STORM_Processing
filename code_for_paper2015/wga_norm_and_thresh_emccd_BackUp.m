...
%%
path = [exp_folder  'unaligned/storm_merged/'];
path2 = [exp_folder  'unaligned/conv_merged/'];
%Does this path3 mean we have to put WGA in a specific channel? 
path3 = [exp_folder  'unaligned/conv_561_storm488/'];
%WT? conv_merged images are stored in variable stromfiles? 
stormfiles = [dir([path2 '*.png']) dir([path2 '*.tif'])];
...
B4(A4<1)=0;
    ...
    Balign = imadd(imadjust((B4),[0 1],[0 0.6]),B3);
